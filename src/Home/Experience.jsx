  ...
  const jobs = [
    {
      ...
      learned:
        "From this role, I learned how to probelm solve in a professional environment, becoming an expert at SOPs and Action Plans. Delegating was a key skill I developed the hard way.",
    },
    {
      company: "Chartwells Higher Education",
      ...
      learned:
        "In this role, I learned the importance of time management and associate engagment. To meet my goals, I had to get get 50 people on board to do things the right way.",
    },
    {
      ...
      learned:
        "This role taught me to value of self confidence. In order to succesfully capture clients, I first had to believe I was capable of doing so. ",
    },
    {
      ...
      timeframe: "2015-2017",
      responsibilities:
        "Managing a shift that consisted of 20+ associates, I was the first line of training and interaction with both customers and associates. Implementing the training programs written by the Director and cooordinating with other leaders was my primary responsibility.",
      learned:
        "This role taught me the value of excelling wherever I am. It wasn’t always glamorous or high-profile, but it often served as a keystone, holding things together when it mattered most.",
    },
  ];
