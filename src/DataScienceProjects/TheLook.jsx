...
const TheLook = () => {
        ...
        <>
          <div>
            ...
            <p>
              ...
              The First Session and Last Session graphs were tightly clustered,
              so I added the measure Last Sessions - First Sessions, which
              should be a good indicator of returning traffic. The reference
              line in red is 0, meaning data below this line indicates more last
              sessions than first sessions. From this graph, it's obvious that
              TheLook began experiencing troubling user trends that began in
              April of 2023, and became more evident by July of the same year.
              Because there is no narrative for TheLook dataset, I can only
              speculate on the spikes that occur in all of the data, but it
              would appear that there was a very large "Going Out of Business"
              sale that occurred in January 2024, and the data shows that there
              was a large influx of new users, but the retention rate was very
              low.
            </p>
          </div>
        </>
        ...
        <>
          <div>
            <p>
              ...
              approximate 50/50 split in gender is unique among online
              retailers, with the ultimate comparison being Amazon, who has a
              75/25 percent split in favor of female shoppers. This split likely
              has an impact on product cost, though in what way isn't clear from
              this data.
            </p>
            <p>
            ...
            <p>
              As gender and age were the only 2 demographic axes available in
              the data, this was the primary limitation of the demographic
              analysis.
            </p>
          </div>
        </>
        ...
        <>
          <div>
            <p>
              ...
              brands, and the top 7 categories are well defined, high unit
              volume categories.
            </p>
          </div>
        </>
        ...
        <>
          <div className="text-base space-y-8">
            <p>
              ...
              Lounge didn't make the top 7 categories in terms of profit, and
              was replaced in the ranking by Tops & Tees.
            </p>
            <p>
        ...
        <>
          <div>
            <p>
              ...
              months of the company's history could be a possible cause of the
              dropping customer retention rates reference in the first section
              of analysis. Through most of 2020, processing time averages were
              above 2.5 days, and some months up to 3. When competing online
              retail processing time averages of 1-1.5 days, this is a
              significant difference. Even after the company stabilized it's
              purchasing times, 2 days falls well behind the industry average.
            </p>
            <p>
              Looking further into the order processing data, we see that
              TheLook had extraordinary low return rates, compared to other
              clothing retailers. The average return rate reported by Amazon for
              their Clothing category is between 15-45%. In this light, the 10%
              lifetime return rate is a very
            </p>
          </div>
        </>
      ),
        ...
        <>
          <div>
            <p>
              ...
              cost from each order. The running cost % is extrapolated over a 1
              month period for consistency.
            </p>
            <p>
        ...
        <>
          <div>
            <p>
              ...
              the user was tracked for the remained of the available data
              period.
            </p>
            <p>
  ...
  return (
    <div className="card-drawer" id="thelook">
